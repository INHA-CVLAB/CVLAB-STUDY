...
def unpickle(file):
    with open(file, 'rb') as fo:
        dict = pickle.load(fo, encoding='bytes') #read pickled instance
    return dict
...
def load_data(files, data_dir, label_count): #[data_batch_1, ... , data_batch_5], '../data/cifar-10-batches-py', 60000
...
def prepare_data():
    ...
    label_names = meta[b'label_names'] #label information
    label_count = len(label_names)
    train_files = ['data_batch_%d' % d for d in range(1, 6)] #[data_batch_1, ... , data_batch_5]
