...
DEPTH = 164 # or 1001
MODEL_NAME = 'ResNet{}'.format(DEPTH) # This should be modified when the model name changes.
...
class ResNet164(BaseModel):
    ...
    Cifar10 - Error Rate 5.46%(Pre-activation)
    Cifar100 - Error Rate 24.33%(Pre-activation)
